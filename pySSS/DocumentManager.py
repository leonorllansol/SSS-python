...
def generateCandidates(inputQuestion, indexPath=configParser.getIndexPath(), corpusPath=configParser.getCorpusPath()):

    hitsPerQuery = int(configParser.getHitsPerQuery())
