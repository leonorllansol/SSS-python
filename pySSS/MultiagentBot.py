...
async def on_message(message):
    ...
    if(not message.author.bot):
        ...
        interaction = {"query": query, "answer": answer, "userID": message.author.id, "posReacts": 1, "negReacts": 1, "midReacts": 1, "timestamp": time.time(), "messageID": message.id, "serverID": message.guild.id}
