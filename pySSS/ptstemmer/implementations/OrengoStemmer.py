...
class OrengoStemmer(Stemmer):
    ...
    def __readRulesFromXML(self):
        try:
            ...
            raise PTStemmerException('Problem while parsing Orengo\'s XML stemming rules file ')
        ...
        for step in root:
            ...
            for rule in step:
                ...
                try:
                    ...
                    raise PTStemmerException('Problem while parsing Orengo\'s XML stemming rules file: Missing or invalid rules properties on step '+stepName+')')
